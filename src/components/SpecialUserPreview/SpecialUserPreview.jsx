...
function SpecialUserPreview({ setUsername, t }) {
  ...
  return (
    <div className="p-5 max-w-4xl mx-auto rounded-lg mt-5  social-link">
...
export default SpecialUserPreview;
